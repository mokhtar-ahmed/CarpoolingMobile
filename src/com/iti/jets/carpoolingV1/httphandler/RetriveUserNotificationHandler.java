...
public class RetriveUserNotificationHandler extends AsyncTask<String, Void, String> {
	
	String output;
	EventsHomeController controller;
    
	String url = HttpConstants.SERVER_URL + HttpConstants.RETRIEVE_USER_NOTIFICATION_SERVICE_URL;
	
	public RetriveUserNotificationHandler(EventsHomeController controller){
