...
public class MarkNotificationAsReaded extends AsyncTask<String, Void, String> {
	
	String output;
	
    
	String url = HttpConstants.SERVER_URL + HttpConstants.MARK_NOTIFICATION_AS_READED_SERVICE_URL;
	
	public MarkNotificationAsReaded(){
