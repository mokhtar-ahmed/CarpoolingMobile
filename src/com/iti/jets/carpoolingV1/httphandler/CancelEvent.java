...
public class CancelEvent extends AsyncTask<String, Void, String> {
	
	String output;
	EventDetialsController controller;
    
	String url = HttpConstants.SERVER_URL + HttpConstants.CANCEL_EVENT_SERVICE_URL;
	
	public CancelEvent(EventDetialsController controller){
...
protected String doInBackground(String... params) {
	       ...
	       return output;
	        ...
	        protected void onPostExecute(String result) {
	        	...
	        	controller.onCancelPostExecute(result);
	        }
}
