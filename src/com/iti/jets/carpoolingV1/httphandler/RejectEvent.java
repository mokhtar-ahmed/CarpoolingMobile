...
public class RejectEvent extends AsyncTask<String, Void, String> {
	
	String output;
	
	RequestsHomeController controller1 = null;
	
	String url = HttpConstants.SERVER_URL + HttpConstants.REJECT_EVENT;
	
	
	
	public RejectEvent(RequestsHomeController controller){
...
protected String doInBackground(String... params) {
	       ...
	       return output;
	        ...
	        protected void onPostExecute(String result) {
	        		...
	        		controller1.onRejectPostExecute(result);
