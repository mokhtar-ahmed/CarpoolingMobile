...
public class SearchEventByDriverServiceHandler extends AsyncTask<String, Void, String> {
	
	String output;
	
	SearchHomeController controller1 = null;
	
	String url = HttpConstants.SERVER_URL + HttpConstants.SEARCH_EVENT_BY_DRIVER;
	
	
	
	public SearchEventByDriverServiceHandler(SearchHomeController controller){
...
protected String doInBackground(String... params) {
	       ...
	       return output;
	        ...
	        protected void onPostExecute(String result) {
	        		...
	        		controller1.onDriverPostExecute(result);
