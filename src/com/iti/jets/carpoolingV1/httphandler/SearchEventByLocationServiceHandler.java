...
import com.iti.jets.carpoolingV1.SearchHome.SearchHomeController;
...
public class SearchEventByLocationServiceHandler extends AsyncTask<String, Void, String> {
	
	String output;
	
	SearchHomeController controller1 = null;
	
	String url = HttpConstants.SERVER_URL + HttpConstants.SEARCH_EVENT_BY_LOCATION;
	
	
	
	public SearchEventByLocationServiceHandler(SearchHomeController controller){
...
protected String doInBackground(String... params) {
	       ...
	       return output;
	        ...
	        protected void onPostExecute(String result) {
	        		...
	        		controller1.onLocationPostExecute(result);
